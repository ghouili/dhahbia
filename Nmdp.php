...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["new_password"]))){
        $new_password_err = "Entez votre nouveau mot de passe .";     
    ...
    // old password [compare] pssword <= findByid($_SESSON["id"])
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Mot de passe oublier</h1>
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"> 
            ...
            <div class="form-group">
                ...
                <a class="btn btn-link ml-2" href="login.php">Annuler</a>
            </div>
        </form>
    </div>
     <!-- Footer Start -->
